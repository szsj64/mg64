...
python3 "${SCRIPT_DIR}/match.py" -j "${JMS_INPUT_PATH}" -u "${JMS_LINKS_PATH}" -m "${MG1964_INPUT_PATH}" -g -v -l -r report_M_6.txt -M 6 -F -Y -P -n -e -a -s -d -O matched_M_6.txt
python3 "${SCRIPT_DIR}/match.py" -j "${JMS_INPUT_PATH}" -u "${JMS_LINKS_PATH}" -m "${MG1964_INPUT_PATH}" -g -v -l -r report_M_7.txt -M 7 -F -Y -P -n -e -a -s -d -O matched_M_7.txt
python3 "${SCRIPT_DIR}/match.py" -j "${JMS_INPUT_PATH}" -u "${JMS_LINKS_PATH}" -m "${MG1964_INPUT_PATH}" -g -v -l -r report_M_8.txt -M 8 -F -Y -P -n -e -a -s -d -O matched_M_8.txt
python3 "${SCRIPT_DIR}/match.py" -j "${JMS_INPUT_PATH}" -u "${JMS_LINKS_PATH}" -m "${MG1964_INPUT_PATH}" -g -v -l -r report_M_9.txt -M 9 -F -Y -P -n -e -a -s -d -O matched_M_9.txt
python3 "${SCRIPT_DIR}/match.py" -j "${JMS_INPUT_PATH}" -u "${JMS_LINKS_PATH}" -m "${MG1964_INPUT_PATH}" -g -v -l -r report_M_10.txt -M 10 -F -Y -P -n -e -a -s -d -O matched_M_10.txt